...
% what is your name?
\newcommand{\myname}{E. Michael Nehls}
...
\hypersetup{
    ...
    linkcolor   = black,
    pdfauthor   = {\myname},
    pdfkeywords = {infectious diseases, tuberculosis, mycobacterium, alveolar macrophages, pulmonary immunology},
...
\begin{document}
    ...
    \begin{minipage}[t]{0.295\textwidth}
        ...
        \flushright{}
        \href{mailto:emnehls@wustl.edu}{emnehls@wustl.edu} \\
        +1 303 668 7664 \\
    ...
    \begin{tablist}
        ...
        \item[MD/Ph.D.] \tab{}Molecular Microbiology and Microbial Pathogenesis, Washington University, St. Louis, MO, Expected 2025
        \item[B.S.]  \tab{}Chemical and Biological Engineering \textit{magna cum laude}, University of Colorado Boulder, 2015
    ...
    \begin{tablist}
        ...
        \item[2023] \tab{}G. Boeing, J. Ha, Y. Zhou. \enquote{Improving the Accuracy of Intersection Counts and Densities for Measuring Urban Street Network Compactness and Resilience.} Caltrans, Pacific Southwest Region UTC.\@ Technical report.
    ...
    \begin{tablist}
        ...
        \item[2023] \tab{}\enquote{New Insights into Cities: Urban Data for Urban Planning.} Tech in the City Speaker Series, keynote address. Center for Urban and Regional Analysis, The Ohio State University. Feb 10.
    ...
    \begin{tablist}
        ...
        %\item[2022] \tab{}Planning Institute of Australia (Victoria) Award for Planning Excellence---Planning Research
